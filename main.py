...
storagePath = r"/home/mohammad/Downloads/video_Downloader"
...
def download():
    ...
    if len(url) > 0:
        ...
        msg["text"] = "Downloding" + ytb_url.title
        if quality == choices[0]:
            ...
            print(ytb_url.title)
            audio.download(storagePath)
            # video = "/home/mohammad/Downloads/video_Downloader/PhysicsExplainedinTenSeconds(Announcement).mp4"
            # audio1 = "test.mp3"
            # videoClip = VideoClip(video)
            # audioClip = videoClip.audio
            # audioClip.write_audiofile(audio1)
